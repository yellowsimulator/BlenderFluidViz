...
def test_Gaussian(plot_u=1, version='scalar',save_plot=True):
    """
...
def test_1D(plot_u=3, version='scalar',save_plot=True):
    """
...
if __name__ == '__main__':
    ...
    #test_1D(plot=2, version='scalar',save_plot=True)
    test_Gaussian(plot_u=3, version='scalar',save_plot=True)
